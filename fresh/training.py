...
# Load intents file
with open('fresh\\intents.json') as file:
...
pickle.dump(words, open('fresh\\texts.pkl', 'wb'))
pickle.dump(classes, open('fresh\\labels.pkl', 'wb'))
...
with open('fresh\\training.pkl', 'wb') as model_file:
